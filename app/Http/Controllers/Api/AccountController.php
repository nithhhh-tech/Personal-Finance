...
class AccountController extends Controller
{
    ...
    private function validateData(Request $request, bool $partial = false): array { $rule = $partial ? 'sometimes' : 'required'; return $request->validate(['name' => [$rule,'string','max:120'], 'type' => ['sometimes','string','max:40'], 'currency' => ['sometimes','in:USD,KHR'], 'starting_balance' => ['sometimes','numeric','min:0']]); }
}
